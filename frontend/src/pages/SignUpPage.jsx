...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      {/* Left Side - Form */}
      <div className="flex flex-col justify-start items-center p-6 sm:p-12 pt-20 lg:pt-32">
...
<div className="hidden lg:flex relative">
  ...
  />
  <div className="absolute inset-0 bg-black/40 flex flex-col justify-start items-center text-white text-center p-6 backdrop-blur-[2px] transition-opacity duration-700 ease-in-out pt-56">
    {/* Increased pt-48 instead of pt-32 to push content down */}
    <h2 className="text-5xl font-bold mb-3 animate-fadeIn">
      Join our community
    </h2>
    <p className="max-w-md text-white/90 text-xl">
