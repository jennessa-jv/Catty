...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen grid lg:grid-cols-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  className="input input-bordered w-full pl-10 h-14 text-lg"
      ...
      {/* Right Side - Cat Image with Overlay */}
      <div className="hidden lg:block relative">
        <img
          src="/starry-cat.jpg"
          alt="Cute starry night cat"
          className="object-cover w-full h-full"
        />
        <div className="absolute inset-0 bg-black/40 flex flex-col justify-start items-center text-white text-center p-6 backdrop-blur-[2px] transition-opacity duration-700 ease-in-out pt-48">
          <h2 className="text-4xl font-bold mb-3 animate-fadeIn">
            Welcome back!
          </h2>
